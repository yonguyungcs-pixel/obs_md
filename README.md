...
### v1.1.0 - 2026-07-13
- **优化**: 更新 Excel、PDF 和 Word 转换器逻辑。
- **新增**: 添加 `reset_all.py`、`reset_sfs_all.py` 等批量重置脚本。
- **测试**: 补充 `test_docling_md.py`、`test_pandoc.py` 等转换测试用例。
- **修复**: 优化数据库操作和 Markdown 生成同步逻辑。

### v1.0.1 - 2026-07-08
- **新增**: WPS 相关批量转换脚本 (`convert_wps_batch.py` 等)。
- **新增**: 国际化支持，增加英文版说明文档。

### v1.0.0 - 2026-07-08
- **初始发布**: 实现基于 watchdog 的多格式文档自动监听、AI 处理与 Obsidian 同步。
